...
class VAEArchitecture(ModelArchitecture):
    def __init__(self, inputShape: tuple, latentDim: int = 2 ):
        super().__init__()
    ...
    def buildEncoder(self):
        ...
        encoder = tensorflow.keras.Model(encoderInputs, outputs)
    ...
    def buildDecoder(self):
        ...
        latent_inputs = tensorflow.keras.Input(shape=(self.latentDim,))
        x = tensorflow.keras.layers.Dense(initLayerDim * initLayerDim * 64, activation = 'relu')(latent_inputs)
        ...
        decoder = tensorflow.keras.Model(latent_inputs, decoderOutputs)
